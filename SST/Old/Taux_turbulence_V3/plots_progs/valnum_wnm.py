...
k_c_100MeV = e*B/(100e6*1.6021e-12) #E_c s'exprime en eV
k_c_1GeV = e*B/(1e9*1.6021e-12) #E_c s'exprime en eV
k_c_10GeV = e*B/(10e9*1.6021e-12) #E_c s'exprime en eV
...
print '###############################################'
print 'E_c = 100 MeV <-> k_c = ',k_c_100MeV,'cm^-1'
print 'E_c = 1 GeV <-> k_c = ',k_c_1GeV,'cm^-1'
print 'E_c = 10 GeV <-> k_c = ',k_c_10GeV,'cm^-1'
