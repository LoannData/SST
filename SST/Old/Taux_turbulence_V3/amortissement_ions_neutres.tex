...
\begin{figure}[h]
  \begin{center}
   ...
   \subfloat[Dense Core $E_c = 10~\mathrm{GeV}$]{
    ...
    \caption{Résultats graphiques du comportement de $F(E)$ normalisé par un gradient moyen de l'ordre de $1\times 10^{-30}$ caractéristique de ce que l'on trouve dans l'ISM.}
